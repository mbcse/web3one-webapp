...
import WalletAddressModal from '../modals/WalletAddressModal/WalletAddressModal'
...
const FAQ = function (props) {
  ...
  return (
    <div>
      <h4> The most powerfull wallet ever made </h4>
      {/* <h3>{}</h3> */}
    </div>
    // <div className={`${styles.faQuestions}`}>
    //   <h5 className={styles.faQuestions__header}>
    //     <h3>ENS</h3>
    //     {/* <FormattedMessage id="MainFAQHeader" defaultMessage="ENS" /> */}
    //   </h5>
